	...
	<!--inicio modal de excluir formulário-->
		...
		<div id="modal1" class="modal" style="background-color: #30566B;">
			<div class="modal-content">
				<h6 style="color: white;">Deseja excluir o paciente?</h6>
			</div>
...
<div class="col s5">
				...
				margin-left: auto;
				margin-right: auto; width: auto; height: auto; border-style: double; border-color: #5ABBE5; color: white; text-align: right;">Excluir</button>
</div>		</div>	
	</div>
		</div>
		...
		<div id="modal2" class="modal">
			<div class="modal-content" style="background-color: #30566B;">
				...
				<h6 style="color: white;">O paciente foi removido com sucesso.</h6>
			</div>
			<div class="modal-footer" style="background-color: #30566B;">
				
				<a href="pacientes.html"><button class=" avanar valign-text-middle exo2-bold-white-16px modal-trigger fechar-modal modal-close" style="margin-top: 0px; display: inline-block;
